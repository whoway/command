...
- 4、<font style="background:yellow" size=3>Windows下的命令是不区分大小写的!（请牢记）</font>
- 5、“批处理”学习利器：<font style="background:yellow" size=3> **让/?`命令，陪伴你的整个学习过程！（最便捷和常用的方式）**</font>     看不懂意思就自行用【百度翻译】等
